...
class Binary_search_tree:
    def __init__(self, data) -> None: 
        ...
        self.left = None
        self.right = None   
    # To search among data if it exists =>True   
    def search(self,val):    
        if self.data == val:
            return True
        elif self.data > val:
...
print("inorder_traverse is :",root.inorder_traversal())
# inorder_traverse is : [3, 9, 12, 15, 20, 99, 123]
# 15
# 9
...
print("This is search number :",root.search(12))
# This is search number : True

# to see the reverse we must implement these two func together
print("this is reverse :",root.reverse())
print("inorder_traverse is :",root.inorder_traversal())
#inorder_traverse is : [123, 99, 20, 15, 12, 9, 3]